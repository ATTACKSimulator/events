...
class EventSender {
    ...
    send(payloadDraft_1) {
        return __awaiter(this, arguments, void 0, function* (payloadDraft, options = {}) {
...
class Manager {
     ...
     * @returns {Promise<void>} - A promise that resolves when the event is executed.
     */
    executeEvent(activeEvent_1, event_1) {
        return __awaiter(this, arguments, void 0, function* (activeEvent, event, shouldValidate = true) {
...
(function (window, undefined) {
    ...
    if (typeof exports !== TYPEOF.UNDEFINED) {
        // nodejs env
        if ("object" !== TYPEOF.UNDEFINED && module.exports) {
            exports = module.exports = UAParser;
        }
        exports.UAParser = UAParser;
    } else {
        // requirejs env (optional)
        if ("function" === TYPEOF.FUNCTION && __webpack_require__.amdO) {
...
/******/ 	let __webpack_exports__ = __webpack_require__("./index.ts");
